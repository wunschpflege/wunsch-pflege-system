...
router.patch('/mitarbeiter/:id', async (req, res, next) => {
  try {
   const felder=['vorname','nachname','handzeichen','telefon1','telefon2','mobiltelefon','telefax','email','qualifikation','beschaeftigung','stunden_woche','ist_pflegekraft','bezirk_id','wg_id','bemerkungen','notizen','status','aktiv','strasse','plz','ort','geburtsdatum','geschlecht','beschaeftigungsnummer','eintrittsdatum','austrittsdatum','pflegeteam'];
    const upd=[],params=[];
